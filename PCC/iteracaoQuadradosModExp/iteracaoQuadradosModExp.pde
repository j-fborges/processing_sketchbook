...
float uniSz = 15,// "universal size" ------------ tamanho do modulo geral, que cria o grid.
uniMarginSz = 0,       //  "universal margin size" ------------ tamanho da margem geral de todos os objetos
uniASzMax =19,         // "universal acutal size maximum" ------------ Tamanho maximo do objeto que vai ser desenhado dentro ou fora do espaço do modulo. Os tamanhos são gerados a partir de randomização, tendo um máximo ou mínimo
uniASzMin =12;         // "universal actual size minimum" ------------- Tamanho minimo.
float cDSz = 15;              // "colision detection size" ---------------- Distancia para detecção de disponibilidade para cada "spot".
float uniXSz = uniSz, uniYSz = (uniSz/prop);


int sqrsN, spotsN, pSpotsN = 1, occupiedN;
int tR = 5;
String cat1 = "medioGrandeConstante", cat2 = "AA";
